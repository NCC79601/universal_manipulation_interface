...
def main(input_dir, map_path, docker_image, no_docker_pull, no_mask):
    ...
    # feat: add absolute camera trajectory output
    abs_csv_path = mount_target.joinpath('mapping_absolute_camera_trajectory.csv')
    ...
    cmd = [
        ...
        # feat: add absolute camera trajectory output
        '--output_absolute_trajectory_csv', str(abs_csv_path),
        # feat: add point cloud output
